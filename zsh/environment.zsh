...
export PATH="/opt/venv/bin:/opt/homebrew/opt/postgresql@15/bin:/opt/homebrew/opt/python/libexec/bin:/opt/homebrew/opt/openjdk/bin:$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:$HOME/.asdf/shims:/opt/homebrew/opt/node@18/bin:/opt/homebrew/sbin:/opt/homebrew/bin:$PATH"
