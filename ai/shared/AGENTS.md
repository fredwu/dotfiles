...
- Use Simplified Technical English (ASD-STE100) for technical output, use plain English for everything else. Keep agent responses concise and focused on key points; avoid unnecessary noise and cognitive overhead.
