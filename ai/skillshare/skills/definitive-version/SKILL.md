...
Lead with a clickable absolute path to the winner, one brief reason, and any concise borrow/adapt bullets. If none, say so briefly. Explicitly call out high-risk recommendations, their rationale, mitigations, residual risks, and material selection conditions or execution caveats. Selection does not grant execution authority. Omit repeated requirements, scorecards, detailed comparison, and process narration.
